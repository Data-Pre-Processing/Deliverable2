...
census_pop = census_pop|>
  ...
  rename(population_est_2010 = `7/1/2019 population estimate`)

write_csv(census_pop, "census_clean.csv")

str(census_pop) #to check if properly formatted

saveRDS(census_pop, "census_formatted.rds")
```
...
write.csv(cleaner, "clean_wiki.csv")
...
saveRDS(cleaner, "formatted_wiki.rds")
```
